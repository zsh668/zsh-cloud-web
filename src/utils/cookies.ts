...
const tenantKey = 'admin_access_tenant'
...
// 租户
export const getTenant = () => localStorage.getItem(tenantKey)
export const setTenant = (tenant: string) => localStorage.setItem(tenantKey, tenant)
export const removeTenant = () => localStorage.removeItem(tenantKey)
